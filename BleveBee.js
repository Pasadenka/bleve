function Bee() {
    if ( typeof Bee.prototype.uniqueId === "undefined" ) {
        var id = 0;
        Bee.prototype.Id = function() {
...
bleve = function () {
    ...
    this.dependencyAssign = function (depyd, assigner, assignees, done, autoUnassign) {
        ...
        var crpt = typeof crypto === "undefined"?msCrypto:crypto;

        var dependency = crpt.getRandomValues(new Uint32Array(1))[0];
        var childrenList = [];
        autoUnassign = (typeof autoUnassign === "boolean")?autoUnassign:false;
        assigner = (assigner === 0)?{Id:function(){return 0;}}:assigner;
...
Bee.prototype.bleve = new bleve();

Bee.prototype.unassign = function (listener) {

    Bleve.unassign(listener, this.Id());
}

Bee.prototype.dependencyUnassign = function (depyd, all) {

    Bleve.dependencyUnassign(depyd, all, this.Id());
}

Bee.prototype.assign = function (listener, done, emitor, autoUnassign) {

    Bleve.assign(listener, this, done, emitor, autoUnassign);
}

Bee.prototype.dependencyAssign = function (depyd, assignees, done, autoUnassign) {

    Bleve.dependencyAssign(depyd, this, assignees, done, autoUnassign);
}

Bee.prototype.emit = function (listener, data) {
